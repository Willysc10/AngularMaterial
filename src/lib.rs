// src/lib.rs
/*
 * Core library for AngularMaterial
 */
...
#[derive(Debug)]
pub struct AngularMaterialProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AngularMaterialProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AngularMaterial processing");
    
    let mut processor = AngularMaterialProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AngularMaterialProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AngularMaterialProcessor::new(false);
